...
class DisplayFacade
{
  ...
  private:
    ...
    DeviceDisplay::WidgetAction convertFacadeFlagsToDeviceFlags(std::initializer_list<DisplayFacade::WidgetAction> actionFlags)
    {
        DeviceDisplay::WidgetAction deviceFlags = DeviceDisplay::WidgetAction::NoAction;
        for (DisplayFacade::WidgetAction flag : actionFlags)
        {
            switch (static_cast<DeviceDisplay::WidgetAction>(flag))
            {
                switch (flag)
                {
