 ...
 * @param display pointer to the i2cDisplay object.
 */
void Widgets::OpenKNXLogo(i2cDisplay *display)
{
 ...
 * @param display pointer to the i2cDisplay object.
 */
void Widgets::ShowBootLogo(i2cDisplay *display)
{
    display->display->clearDisplay();
    display->display->drawBitmap(
 ...
 * @param display pointer to the i2cDisplay object.
 */
void Widgets::showProgrammingMode(i2cDisplay *display)
{
 ...
 * @param display pointer to the i2cDisplay object.
 */
void Widgets::showMatrixScreensaver(i2cDisplay *display)
{
    // CP437 character set
 ...
 * @param display pointer to the i2cDisplay object.
 */
void Widgets::showPongScreensaver(i2cDisplay *display)
{
...
void Widgets::showClockScreensaver(i2cDisplay *display, bool rounded)
{
    ...
    if (openknx.time.isValid())
    {
        ...
        minutes = time.minute;
        seconds = time.second;
        rounded = true; // Let's always show a rounded clock when time is available.
    }
    else
    {
...
void Widgets::showRainfallScreensaver(i2cDisplay *display, uint8_t intensity)
{
...
void Widgets::showMatrixScreensaverP(i2cDisplay *display, uint8_t intensity)
{
    static unsigned long _lastUpdateScreenSaver = 0;
...
void Widgets::show3DCubeScreensaver(i2cDisplay *display)
{
...
void Widgets::showStarfieldScreensaver(i2cDisplay *display, uint8_t intensity)
{
    static unsigned long lastUpdate = 0;
...
void Widgets::showLifeScreensaver(i2cDisplay *display)
{
    static unsigned long lastUpdate = 0;
...
void Widgets::showQRCode(i2cDisplay *display)
{
